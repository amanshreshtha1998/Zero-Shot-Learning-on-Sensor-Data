...
aam = aam.T
print (aam.shape)
aam.to_csv(r'F:/year 3/zsl/class_embedding/activity_attribute_matrix_not_probability300.csv', header = class_names, index = None)

#%% LOAD DATA

df = pd.read_csv('F:/year 3/zsl/class_embedding/activity_attribute_matrix_not_probability300.csv')
...
aam_p_df.to_csv(r'F:/year 3/zsl/class_embedding/activity_attribute_matrix300.csv', header = class_names, index = None)
